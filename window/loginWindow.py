...
from loginWindowAction import loginWindowHandler
...
if __name__ == "__main__":
    ...
    ###add this line for new ui converted py code
    h=loginWindowHandler(Dialog,loginBut='loginBut',registerBut='registerBut',\
